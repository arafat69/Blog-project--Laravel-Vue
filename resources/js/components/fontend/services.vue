      ...
      <div class="col-md-12">
        <div class="block text-center">
          ...
          <ul class="list-inline">
            ...
            <li class="list-inline-item"><a class="text-white-50">Our services</a></li>
          </ul>
        </div>
      </div>
    </div>
	...
	<div class="container">
		<div class="cta-block p-5 rounded">
			<div class="row justify-content-center align-items-center ">
				...
				<div class="col-lg-4">
					<a href="javascript:void(0)" class="btn btn-main btn-round-full float-right">Contact Us</a>
				</div>
			</div>
		</div>
	</div>
